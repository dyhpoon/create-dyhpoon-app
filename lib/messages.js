...
exports.help = function() {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/dyhpoon/create-dyhpoon-app/issues/new')}
  `
}
...
exports.start = function(projectName) {
  ...
  ${chalk.green('https://github.com/dyhpoon/create-dyhpoon-app/issues')}
`
}
